...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setupStatusAndNavigationBar() {
    ...
    func setupGlobalAppearance(){
        ...
        UILabel.appearance().font = UIFont(name: "Baskerville", size: 19)
        UITextField.appearance().font = UIFont(name: "Baskerville", size: 19)
        UITextView.appearance().font = UIFont(name: "Baskerville", size: 19)
    }
